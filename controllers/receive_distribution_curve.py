...
receive_distribution_curve_bp = Blueprint("receive_distribution_curve_bp", __name__)

@receive_distribution_curve_bp.route('/receive_distribution_curve', methods=['POST'])
