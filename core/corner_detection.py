...
def harris_corner(img_path, sid):
...
def add_harris_corner(img_path, sid):
...
def apply_harris_corner(img_dir, window_size, k, threshold, sid):
    ...
    img_path = f'./static/db/generated/{sid}/{generate()}_thr_{threshold}.png'
    cv2.imwrite(img_path, img)
    return img_path
