...
def feature_matching(img_path1, img_path2, threshold, mode):
    ...
    if mode == 'ssd':
        ...
        total_time = end-start
    new_path = draw_matches(img1, keypoints_1, img2, keypoints_2, matches[:10])
    print(total_time)
